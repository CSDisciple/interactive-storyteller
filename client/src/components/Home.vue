...
<!--Bootstrap Cards for Trending stories -->
<h3 class = "text-center">Trending stories</h3>
<br>
<div class = "card-deck">

<!-- First Trending Story -->
      <div class="col-md-4">
        <div class="card mb-2">
          <img class="card-img-top"
            src="https://i.imgur.com/m8Heqoc.png"
            alt="Card image cap">
          <div class="card-body">
...
<!-- Second Trending Story -->
      <div class="col-md-4">
        <div class="card mb-2">
          <img class="card-img-top"
            src="https://i.imgur.com/1mY1f0s.png"
            alt="Card image cap">
          <div class="card-body">
...
<!-- Third Trending Story -->
      <div class="col-md-4">
        <div class="card mb-2">
          <img class="card-img-top"
            src="https://i.imgur.com/sZmU5u5.png"
            alt="Card image cap">
          <div class="card-body">
...
<!-- Fourth Trending Story -->	
     <div class="col-md-4">
        <div class="card mb-2">
          <img class="card-img-top"
            src="https://i.imgur.com/MVbVJQD.png"
            alt="Card image cap">
          <div class="card-body">
...
<!-- Fifth Trending Story -->
      <div class="col-md-4">
        <div class="card mb-2">
          <img class="card-img-top"
            src="https://i.imgur.com/eCumBC0.png"
            alt="Card image cap">
          <div class="card-body">
...
<!-- Sixth Trending Story -->
     <div class="col-md-4">
        <div class="card mb-2">
          <img class="card-img-top"
            src="https://i.imgur.com/bNbPvte.png"
            alt="Card image cap">
          <div class="card-body">
